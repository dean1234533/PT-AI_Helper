    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="lg:hidden fixed bottom-24 left-4 z-30 flex items-center gap-2 px-3 py-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-xs font-semibold rounded-full shadow-lg transition-all hover:scale-105 active:scale-95"
