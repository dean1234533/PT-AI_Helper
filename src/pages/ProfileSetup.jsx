          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1 bg-brand-600 text-white rounded-md text-xs font-semibold"
              >
                Analyze Body
              </button>
              <button
      ...
      <div className="max-w-4xl mx-auto px-4 pt-12">
        ...
        <div className="mb-10">
          <div className="flex justify-between items-center relative">
            ...
            <div
              className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-gradient-to-r from-brand-600 to-emerald-500 z-0 transition-all duration-300"
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 border ${
                      isCompleted
                        ? 'bg-gradient-to-tr from-brand-600 to-emerald-500 border-transparent text-white'
                        : isActive
                        ? 'bg-slate-900 border-brand-500 text-brand-400 shadow-lg shadow-brand-500/20'
                  ...
                  <span
                    className={`hidden sm:block text-xs font-medium mt-2 transition-all ${
                      isActive ? 'text-brand-400 font-bold' : isCompleted ? 'text-slate-300' : 'text-slate-500'
                    }`}
                  >
                    {step.title}
                  </span>
        ...
        <div className="bg-slate-900/40 border border-slate-800/80 rounded-3xl p-6 sm:p-10 backdrop-blur-xl shadow-2xl relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/80 border border-slate-800 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 rounded-2xl py-3 px-4 text-slate-100 text-sm outline-none transition-all"
                  />
                </div>
                    ...
                    {['Male', 'Female', 'Other'].map((g) => (
                      <button
                        ...
                        className={`py-3 px-4 border text-sm font-semibold rounded-2xl transition-all ${
                          formData.gender === g
                            ? 'bg-gradient-to-tr from-brand-600 to-brand-700 border-transparent text-white'
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950/80 border border-slate-800 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 rounded-2xl py-3.5 px-4 text-slate-100 text-sm outline-none transition-all cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    >
                      ...
                      <span className={`text-[10px] text-center ${formData.fitnessLevel === level.value ? 'text-brand-200' : 'text-slate-500'}`}>
                        {level.desc}
                      </span>
                    </button>
                  ))}
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center justify-center border-2 border-dashed border-slate-800 hover:border-brand-500/50 rounded-3xl p-8 bg-slate-950/20 transition-all relative">
                {imagePreview ? (
                  <div className="relative group max-w-xs w-full rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                      <label className="p-3 bg-brand-600 hover:bg-brand-500 rounded-full cursor-pointer text-white shadow-lg transition-transform hover:scale-105">
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-64 cursor-pointer group">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center space-y-3">
                      <div className="p-4 bg-slate-900 border border-slate-800 rounded-2xl text-slate-400 group-hover:text-brand-400 group-hover:border-brand-500/30 group-hover:shadow-lg group-hover:shadow-brand-500/5 transition-all">
          ...
          <div className="flex justify-between items-center mt-10 pt-6 border-t border-slate-800/80">
            ...
            {currentStep < STEPS.length - 1 ? (
              <button
                onClick={handleNext}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-500 hover:to-brand-600 text-white text-sm font-semibold rounded-2xl shadow-lg shadow-brand-600/10 transition-all hover:shadow-brand-600/20"
              >
                Next Step
